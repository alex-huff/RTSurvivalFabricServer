...
public abstract
class AbstractServerCommand implements IServerCommand
{
    ...
    public
    AbstractServerCommand(String name)
    {
        this.name = name;
    }
    ...
    protected
    void addSubCommand(IServerCommand subCommand)
    {
    ...
    protected
    int execute(CommandContext<ServerCommandSource> source, CommandExecutor<ServerCommandSource> executor)
    {
        try
        {
