...
public
class V1SWWaypoint implements SWSerializable
{
    ...
    public
    V1SWWaypoint(String name, V1SWLocation location)
    {
        this.name     = name;
    ...
    public static
    V1SWWaypoint fromBytes(DataInputStream dis) throws IOException
    {
