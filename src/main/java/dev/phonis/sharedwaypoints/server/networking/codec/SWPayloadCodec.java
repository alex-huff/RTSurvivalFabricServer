...
public
class SWPayloadCodec implements PacketCodec<RegistryByteBuf, SWPayload>
{
    @Override
    public
    SWPayload decode(RegistryByteBuf buf)
    {
    ...
    @Override
    public
    void encode(RegistryByteBuf buf, SWPayload value)
    {
