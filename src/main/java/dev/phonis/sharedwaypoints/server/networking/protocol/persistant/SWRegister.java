...
public class SWRegister implements SWPacket
{

    public final int protocolVersion;

    public SWRegister(int protocolVersion)
    {
    ...
    public static SWRegister fromBytes(DataInputStream dis) throws IOException
    {
