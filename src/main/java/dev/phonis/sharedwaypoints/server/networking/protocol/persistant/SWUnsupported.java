...
public class SWUnsupported implements SWPacket {

    public final int protocolVersion;

    public SWUnsupported(int protocolVersion) {
    ...
    public static SWUnsupported fromBytes(DataInputStream dis) throws IOException {
