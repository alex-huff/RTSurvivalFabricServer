...
public
class V1SWWaypointUpdate implements SWPacket
{

    public final V1SWWaypoint newWaypoint;

    public
    V1SWWaypointUpdate(V1SWWaypoint newWaypoint)
    {
    ...
    public static
    V1SWWaypointUpdate fromBytes(DataInputStream dis) throws IOException
    {
